...
import { ElementIri, ElementModel, Dictionary, LocalizedString, Property } from 'graph-explorer/src/graph-explorer/data/model';
...
export class TestTemplate extends React.Component<TemplateProps, {}> {
    ...
    render() {
        ...
        return (
            <div className='graph-explorer-standard-template'
